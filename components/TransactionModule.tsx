...
import { Plus, X, Edit2, Trash2, ArrowRightLeft, TrendingUp, TrendingDown, ArrowRight, Camera, Loader2 } from 'lucide-react';
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
             <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-500 text-sm">View and manage your history</p>
                </div>
